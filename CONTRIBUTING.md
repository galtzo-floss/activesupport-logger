...
- One spec file per class/module. For each class or module under `lib/`, keep all of its unit tests in a single spec file under `spec/` that mirrors the path and file name exactly: `lib/activesupport/logger/my_class.rb` -> `spec/activesupport/logger/my_class_spec.rb`.
...
[🧪build]: https://github.com/galtzo-floss/activesupport-logger/actions
