...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/activesupport/logger/version.rb", mod) }::Activesupport::Logger::Version::VERSION
  else
    require_relative "lib/activesupport/logger/version"
    Activesupport::Logger::Version::VERSION
  end
