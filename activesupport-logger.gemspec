...
Gem::Specification.new do |spec|
  ...
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/activesupport/logger/version.rb", mod) }::ActiveSupport::Logger::Version::VERSION
  spec.authors = ["Peter H. Boling"]
  spec.email = ["floss@galtzo.com"]

  spec.summary = "💎 Rails v8 ActiveSupport::Logger backported to Rails v5.2+ & Ruby 3.1+"
  spec.description = "💎 Rails v8 ActiveSupport::Logger backported to Rails v5.2+ & Ruby 3.1+"
  spec.homepage = "https://github.com/galtzo-floss/activesupport-logger"
  spec.licenses = ["MIT"]
  ...
  spec.metadata["homepage_uri"] = "https://github.com/pboling/activesupport-logger"
  ...
  spec.add_development_dependency("rspec-pending_for", "~> 0.1", ">= 0.1.28")
